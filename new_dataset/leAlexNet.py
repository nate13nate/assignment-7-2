...
AlexNet.add(Dense(200, activation='relu'))
AlexNet.add(Dropout(0.1))
AlexNet.add(Dense(100,activation='softmax'))
...
AlexNet.save('./new_dataset/models/alexnet.keras')
lenet.save('./new_dataset/models/lenet.keras')


with open('./new_dataset/history/alexnet', 'wb') as file_pi:
    pickle.dump(history1.history, file_pi)
    
with open('./new_dataset/history/lenet', 'wb') as file_pi:
