...
AlexNet.save('./baselines/models/alexnet.keras')
lenet.save('./baselines/models/lenet.keras')


with open('./baselines/history/alexnet', 'wb') as file_pi:
    pickle.dump(history1.history, file_pi)
    
with open('./baselines/history/lenet', 'wb') as file_pi:
