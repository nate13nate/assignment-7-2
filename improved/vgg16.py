...
scores = model.evaluate(x=x_test,y=one_hot_y_test,batch_size=512)
...
# save model
model.save("./improved/models/keras-VGG16-cifar10.keras")

with open('./improved/history/vgg16', 'wb') as file_pi:
